        ...
        const projectResults = await Promise.allSettled(
            projectEntries.map(async (projectEntry) => {
                ...
                try {
                    ...
                    logger.info(`In Bulk Copy Sched, Invoking Bulk Copy Non-Processing Worker for Batch: ${initiatedBatchName} of Project: ${project}`);
                    ...
                    logger.info(`Final merged params - of project ${project} for batch ${initiatedBatchName} adminPageUri:  ${projectParams.adminPageUri || 'MISSING'}, spToken: ${projectParams.spToken ? 'PRESENT' : 'MISSING'}, driveId: ${projectParams.driveId || 'MISSING'}`);
                    try {
